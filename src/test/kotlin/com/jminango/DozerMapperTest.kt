...
class DozerMapperTest {
    ...
    fun parseEntityListToVOListTest() {
        val outputList = DozerMapper.parseListObjects(inputObject!!.mockEntityList(), PersonVO::class.java)
    ...
    fun parserVOListToEntityListTest() {
        ...
        val outputList = DozerMapper.parseListObjects(inputObject!!.mockVOList(), Person::class.java)
